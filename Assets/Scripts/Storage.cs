...
public class Storage : MonoBehaviour
{
    ...
    [SerializeField] private AutenticatorSO currentUser;
    ...
    {
        path = $"/{currentUser._Name}/pictures/{TextID}";
    }
    ...
    {
        var fileReference = _storageReference.GetReference($"/{currentUser._Name}/files/{file.name}.cs");
    ...
    private IEnumerator UploadPicture(Texture2D picture)
    {
        ...
        var pictureReference = _storageReference.GetReference($"/{currentUser._Name}/pictures/{picture.name}.png");
